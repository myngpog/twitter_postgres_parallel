...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/myngpog/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/myngpog/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/myngpog/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/myngpog/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/myngpog/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/myngpog/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |        4m21.682s          |      1:54.61elapsed       | 
| `pg_normalized_batch`  |        1m17.323s          |      0:31.12elapsed       | 
| `pg_denormalized`      |        0m13.202s          |      0:07.05elapsed       | 
